...
- **Ausgeschaltet** – der komplette Wartungskanal ist blockiert, **auch das Lesen** (kein Dateizugriff, keine Fernkonsole, kein knxOTA Firmware-Update). Nur die reine Geräte-Erkennung antwortet noch.
